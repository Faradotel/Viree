...
export default function HomePage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-purple-50 to-pink-50">
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-sm border-b border-purple-100 px-4 py-3 flex items-center justify-between">
      ...
      {/* Bottom Navigation */}
      <nav className="bg-white/90 backdrop-blur-sm border-t border-purple-100 px-4 py-2">
